...
class PDFKeywordExtractor:
    ...
    #
    def show_validation_ui(self, pf_list, pl_list, em_list, depth_list):
        ...
        lists = [
            ("Profondeur", depth_list),  # D'abord la profondeur
    ...
    def process_standard_pf_pl(self, values_by_keyword):
        ...
        # Pas de vérification ici, l'utilisateur pourra ajuster via l'UI
        self.show_validation_ui(pf_values, pl_values, em_values, depths)
        if not depths:
    ...
    def process_special_pf_pl(self, pf_values, pl_values, values_by_keyword):
        ...
        self.show_validation_ui(pf_final, pl_final, em_values, depths)
